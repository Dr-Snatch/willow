...
const OnboardingView = () => {
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      {/* ── Right: form panel ───────────────────────── */}
      <main className="flex flex-1 flex-col items-center justify-center bg-background px-8 page-enter">

        {/* Mobile logo */}
        <div className="lg:hidden mb-10 flex flex-col items-center gap-4" aria-hidden="true">
        ...
        <div className="w-full max-w-[360px]">
          <h1 className="text-xl font-semibold tracking-tight text-text">Get started</h1>
          <p className="mt-1 mb-6 text-sm text-text-secondary">Takes about 30 seconds.</p>
          ...
          >
            <div className="flex flex-col gap-2">
              <label htmlFor="onboarding-name" className="text-sm font-medium text-text">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-surface px-4 py-3 text-sm text-text placeholder:text-text-muted transition-all duration-300 focus:border-brand/40 focus:outline-none focus:ring-2 focus:ring-brand/20"
              />
              <p className="text-xs text-text-muted" id="name-hint">You can skip this — it's just for the greeting.</p>
            </div>

            <div>
              <label
                htmlFor="consent-check"
                className="flex cursor-pointer items-start gap-3 rounded-xl border border-border bg-surface px-4 py-4 transition-colors duration-300 hover:border-border-strong"
              >
                <input
                  id="consent-check"
                  type="checkbox"
